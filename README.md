...
Scrapes customer discussions from Microsoft Tech Community and Reddit, analyzes them for sentiment, intent, and author role using keyword matching and clustering, and surfaces the insights in an interactive Streamlit dashboard.
